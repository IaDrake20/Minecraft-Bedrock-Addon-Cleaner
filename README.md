...
WIP: Lots. Currently it has no pattern finding for folder or file names and needs exact matches. I plan on having it just rename the unpacked folders to their original names instead of what the creators set it to. 
